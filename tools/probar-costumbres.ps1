...
foreach ($n in 'ConvertTo-Plain', 'Watch-Notificaciones', 'Get-ResumenNotificaciones', 'Get-LecturaNotificaciones',
    'Get-Habitos', 'Save-Habitos', 'Add-Habito', 'Find-Propuesta') { Invoke-Expression (TraerFn $n) }
